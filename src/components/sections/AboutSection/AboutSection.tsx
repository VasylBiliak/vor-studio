    ...
    <main className="min-h-screen bg-white">
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div>
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Наша Історія</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4 text-gray-900">Наша Філософія</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Дизайн</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Якість</h3>
            <p className="text-gray-600">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-900">Екологічність</h3>
            <p className="text-gray-600">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[1, 2, 3].map((i) => (
              <div key={i} className="text-center">
                ...
                />
                <h3 className="text-lg font-semibold text-gray-900">Ім'я Прізвище</h3>
                <p className="text-gray-600">Позиція в компанії</p>
              </div>
            ))}
          </div>
        </div>
